...
class TeddyController extends FlareControls {
  ...
  // Hàm để lưu lại user name mà ng dùng nhập
  void setUserName(String value) {
    _userName = value;
  }

  // Hàm để lưu lại password mà ng dùng nhập
  void setPassword(String value) {
    _password = value;
  }

  // Hàm để lưu lại email mà ng dùng nhập
  void setEmailAddress(String value) {
    _emailAddress = value;
  }

  // Hàm để check xem ng dùng có đang nhập password hay không để chạy animation tương ứng
  ...
  // Hàm gọi khi ng dùng submit pass word
  void submitPassword() {
