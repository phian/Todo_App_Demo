...
class SpecialRepeatSheet extends StatefulWidget {
  ...
  final SpecialRepeatChoiceData initChoiceData;

  SpecialRepeatSheet({this.initChoiceData}) {
    specialRepeatChoiceData = initChoiceData;
  }

  @override
  _SpecialRepeatSheetState createState() => _SpecialRepeatSheetState();
}

class _SpecialRepeatSheetState extends State<SpecialRepeatSheet> {
  ...
  void _initPreviousChoiceState() {
    setState(() {
      if (widget.specialRepeatChoiceData.isOnOrOff == 0) {
        _opacitiesForFirstMenu[0] = 1.0;
        _opacitiesForFirstMenu[1] = 0.0;
      ...
      switch (widget.specialRepeatChoiceData.endsChoice) {
        ...
        case 1:
          ...
          _endSecondChoiceCount =
              widget.specialRepeatChoiceData.endsAfetrNumberOfTimesChoice;
          _endSecondChoiceMultiCountText =
        ...
        default:
          ...
          _initTimeForEndDay = widget.specialRepeatChoiceData.endsDateChoice;
